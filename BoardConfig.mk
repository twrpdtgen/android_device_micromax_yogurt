...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 buildvariant=user buildvariant=userdebug
...
BOARD_MICROMAX_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product
